#ifndef COUNTING_SORT_COMMON_HLSLI
#define COUNTING_SORT_COMMON_HLSLI
...
RWStructuredBuffer<uint> g_RW_CellCount : register(u10);
RWStructuredBuffer<uint2> g_RW_ParticleCellInfo : register(u11);
RWStructuredBuffer<uint> g_RW_CellStart : register(u12);
RWStructuredBuffer<uint> g_RW_PartialSum : register(u13);
...
StructuredBuffer<uint> g_CellCount : register(t8);
StructuredBuffer<uint2> g_ParticleCellInfo : register(t9);
StructuredBuffer<uint> g_CellStart : register(t10);
StructuredBuffer<uint> g_PartialSum : register(t11);
